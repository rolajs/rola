...
/* harmony import */ var flatted_esm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! flatted/esm */ "../node_modules/flatted/esm/index.js");
/* harmony import */ var _lib_matcher_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/matcher.js */ "../lib/matcher.js");
/* harmony import */ var _history_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./history.js */ "../history.js");
/* harmony import */ var _state_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./state.js */ "../state.js");
/* harmony import */ var _link_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./link.js */ "../link.js");
/* harmony import */ var _router_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./router.js */ "../router.js");
...
function client(routes) {
  ...
  var serverState = Object(flatted_esm__WEBPACK_IMPORTED_MODULE_4__["parse"])(JSON.stringify(window.__hypr));
  _state_js__WEBPACK_IMPORTED_MODULE_7__["store"].hydrate(_objectSpread({}, serverState, initialState, {
    router: {
      location: location,
      params: params
    }
  ...
  return function render(root) {
    Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["hydrate"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_picostate_react__WEBPACK_IMPORTED_MODULE_3__["Provider"], {
      store: _state_js__WEBPACK_IMPORTED_MODULE_7__["store"]
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_router_js__WEBPACK_IMPORTED_MODULE_9__["default"], {
      router: router,
      location: location,
      resolve: function resolve(_ref2, done) {
        var location = _ref2.location,
            params = _ref2.params,
            route = _ref2.route;
        _state_js__WEBPACK_IMPORTED_MODULE_7__["store"].hydrate({
          router: {
            location: location,
            params: params
          }
        ...
        var _route$load = route.load,
            ...
            view = route.view;
        Promise.resolve(load(_state_js__WEBPACK_IMPORTED_MODULE_7__["store"].state)).then(function (_ref3) {
          var redirect = _ref3.redirect,
              _ref3$meta = _ref3.meta,
              meta = _ref3$meta === void 0 ? {} : _ref3$meta,
              props = _ref3.props;
          if (redirect) return _history_js__WEBPACK_IMPORTED_MODULE_6__["history"].pushState(redirect.to);
          _state_js__WEBPACK_IMPORTED_MODULE_7__["store"].hydrate(props);
          Promise.resolve(options.resolve && options.resolve(_state_js__WEBPACK_IMPORTED_MODULE_7__["store"].state)).then(function () {
            document.title = meta.title || document.title;
            done(route.view(_state_js__WEBPACK_IMPORTED_MODULE_7__["store"].state));
          }).catch(function (e) {
            console.log(e);
    ...
    }, route.view(_state_js__WEBPACK_IMPORTED_MODULE_7__["store"].state))), root);
  };
}
...
/* harmony import */ var hypr_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! hypr/client */ "../client.js");
/* harmony import */ var _src_routes_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/src/routes/index.js */ "./src/routes/index.js");



Object(hypr_client__WEBPACK_IMPORTED_MODULE_1__["client"])(_src_routes_index_js__WEBPACK_IMPORTED_MODULE_2__["default"], {})(document.getElementById('root'));
